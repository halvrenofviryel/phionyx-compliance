...
`phionyx-compliance` is a generator of evidence-grade compliance report *drafts* from Phionyx audit chains — it does not certify. It is **alpha / experimental** software. Its value depends on its
...
**founder@phionyx.ai** with `[SECURITY] phionyx-compliance` in the subject. Please do not open a public
issue or PR for a suspected vulnerability until it has been triaged.

Include, where you can: the version (`pip show phionyx-compliance`), a minimal reproduction, and what
